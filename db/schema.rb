...
ActiveRecord::Schema[7.0].define(version: 2023_05_30_185550) do
  ...
  create_table "fish", force: :cascade do |t|
    ...
    t.string "explore_stage", default: "calm"
    t.datetime "final_explore_time"
    t.integer "exploring_time", default: 300
